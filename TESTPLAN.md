...
6. From Super-space, find the fan under **Hearth → Rooms → Office**. Action may toggle; speeds are in the panel.
7. **Rename in HA:** Settings → Devices → Office fan → rename to something obvious (e.g. `Office ceiling fan`).
